...
mkdir -p "$DEV_DIR/state"/{admin,gateway,postgres,qdrant,openmemory,openmemory-ui,opencode-core,channel-chat,channel-discord,channel-voice,channel-telegram,automations,rendered/caddy/snippets,caddy/config,caddy/data,logs,tmp}
...
EOF
for env_name in gateway openmemory postgres qdrant opencode-core channel-chat channel-discord channel-voice channel-telegram; do
