...
OpenPalm uses defense-in-depth with multiple independent layers. For the full breakdown, see [docs/core-principles.md](../docs/core-principles.md) and the "How It Works" section of the [README](../README.md).
