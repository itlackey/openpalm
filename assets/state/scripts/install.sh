...
mkdir -p "$OPENPALM_STATE_HOME"/{admin,gateway,postgres,qdrant,openmemory,openmemory-ui,opencode-core,channel-chat,channel-discord,channel-voice,channel-telegram,automations,rendered,logs,tmp,observability,backups}
...
# generated by admin
EOF
cat > "$OPENPALM_STATE_HOME/opencode-core/.env" <<'EOF'
# generated by admin
EOF
