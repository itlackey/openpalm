...
#
# Exports:
#   OP_UI_LOGIN_PASSWORD — read directly from .dev/knowledge/vaults/secrets/op_ui_login_password.
...
LOGIN_PASSWORD_SECRET="$ROOT_DIR/.dev/knowledge/vaults/secrets/op_ui_login_password"
