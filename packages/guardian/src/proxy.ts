...
// upstream Basic auth (the assistant's OpenCode is always authenticated) is injected
 ...
 * auth (always attached — the assistant authenticates every caller). This is a strip-list model (transparent)
