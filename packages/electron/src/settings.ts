...
// notify behaviour.
//
// Today it holds one field: whether the app's GitHub update check should surface
// PRERELEASE versions (#504). Notify-only — it changes what the update check
// looks for, never how an update is installed.
