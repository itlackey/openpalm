...
import { resolveOpenPalmHome, resolveStateDir, resolveConfigDir, resolveUiBuildDir, seedUiBuild, ensureHomeDirs, } from '@openpalm/lib';
 ...
 */
export function buildUIServerEnv(homeDir, port) {
    return {
        ...process.env,
        OP_HOME: homeDir,
        HOST: '127.0.0.1',
...
// ── UI server lifecycle ──────────────────────────────────────────────────────
export async function waitForReady(port, timeoutMs = READY_TIMEOUT_MS) {
