...
Recovered from git commit 9a189a3^ for benchmark comparison.
"""
...
app = FastAPI(title="OpenPalm Memory API (Python Reference)")

# ---------------------------------------------------------------------------
# Config
# ---------------------------------------------------------------------------

CONFIG_PATH = os.environ.get("MEMORY_CONFIG_PATH", "/app/config.json")
