...
import { detectHostInfo, isAssistantHealthy, main, mainCommand, parseBareArgs } from './main.ts';
import {
	PLATFORM_VERSION,
	readSecret,
...
describe('removed audit-secrets command', () => {
	it('is not registered', () => {
		expect(Object.keys(mainCommand.subCommands ?? {})).not.toContain('audit-secrets');
	});
});
