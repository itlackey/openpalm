export function renderCaddyComposeService(): string {
  return [
    "  caddy:",
...
export function renderPostgresComposeService(): string {
  return [
    "  postgres:",
...
export function renderQdrantComposeService(): string {
  return [
    "  qdrant:",
...
export function renderOpenMemoryComposeService(): string {
  return [
    "  openmemory:",
...
export function renderOpenMemoryUiComposeService(): string {
  return [
    "  openmemory-ui:",
