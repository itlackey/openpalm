 ...
 *
 * `OP_OPENCODE_PASSWORD` is generated by `ensureSystemSecrets()` into
 * config/stack/secrets/op_opencode_password on first run and persists
 * across reruns — it is not regenerated here.
 *
...
export async function performSetup(
  ...
  try {
    ...
    try {
      ...
      writeStackSecretEnv(state, channelSecretUpdates);
