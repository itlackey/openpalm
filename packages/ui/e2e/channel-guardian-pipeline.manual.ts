 ...
 * to OpenCode directly (bypassing guardian) and `containers/guardian/src/server.test.ts`
 * uses a mock
...
const CHANNEL_SECRET_PATH = resolve(REPO_ROOT, `.dev/knowledge/secrets/channel_${TEST_CHANNEL}_secret`);
