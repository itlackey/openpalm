...
import { g as getSetupManager, a as getStackManager, b as allChannelServiceNames, k as knownServices } from './init-C6nnJEAN.js';
import { i as isLocalRequest } from './auth-0WRDks2O.js';
import { s as setRuntimeBindScope, u as updateDataEnv, r as readDataEnv, a as updateRuntimeEnv, b as updateSecretsEnv, v as validateSecretsRawContent, w as writeSecretsRaw, c as readSecretsEnv } from './env-helpers-B-Cb62vD.js';
import { a as applySmallModelToOpencodeConfig } from './opencode-config-CEineNbb.js';
import { c as completeSetupCommandResponse } from './setup-completion-response-FQQRRQU1.js';
import { p as parseStackSpec } from './stack-spec-DIyG4On0.js';
import { s as sanitizeEnvScalar } from './runtime-env-BS_YlF-D.js';
import { a as applyStack } from './stack-apply-engine-CX7GxTsE.js';
import { composeAction, composePull, composeLogsValidateTail, composeLogs, composeList, composePs } from './compose-runner-BT0hCcoV.js';
import { syncAutomations, triggerAutomation } from './automations-CANimQTD.js';
import { p as parse } from './index-CyXiysyI.js';
import { randomUUID } from 'node:crypto';
import { R as RUNTIME_ENV_PATH, S as SECRETS_ENV_PATH } from './config-B06wMz0z.js';
...
const POST = async ({ locals, request }) => {
  ...
  try {
    ...
    if (type === "setup.retry_core") {
      const { setCoreReadinessPhase, applyReadinessResult } = await import('./core-readiness-state-jzvT0zEC.js');
      const { ensureCoreServicesReady } = await import('./core-readiness-DyKdFkeb.js');
      const { SetupStartupServices } = await import('./compose-runner-BT0hCcoV.js');
...
export { POST };
//# sourceMappingURL=_server.ts-rvzETxxT.js.map
