...
import { getRequestId, jsonResponse, requireCapability, withAdminBody } from '$lib/server/helpers.js';
...
/**
 * POST /api/host/providers/oauth/start — Begin an OpenCode-mediated OAuth
