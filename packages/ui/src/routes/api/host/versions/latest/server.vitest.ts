/**
 * Route-level tests for GET /api/host/versions/latest.
 *
...
function makeGetEvent(token = 'admin-token'): Parameters<typeof GET>[0] {
  return {
    url: new URL('http://localhost/api/host/versions/latest'),
    request: new Request('http://localhost/api/host/versions/latest', {
      method: 'GET',
...
describe('GET /api/host/versions/latest', () => {
