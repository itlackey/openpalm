/**
 * GET /api/host/versions  — truthful version state (constitution §4.2, §5)
 * PATCH /api/host/versions — write pins to state file
 *
 ...
 *   /api/host/update via applyStack pull-before-up + fatal pull failure).
 *
...
import { requireAdmin, requireCapability, getRequestId, errorResponse } from "$lib/server/helpers.js";
import {
  readVersions,
  writeVersions,
  readPinnedVersions,
