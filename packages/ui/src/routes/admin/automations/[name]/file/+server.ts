 ...
 *
 *   GET    /admin/automations/<name>/file — read raw contents { name, content }
 *   PUT    /admin/automations/<name>/file — write raw contents (body { content })
 *   DELETE /admin/automations/<name>/file — delete the task file
 *
