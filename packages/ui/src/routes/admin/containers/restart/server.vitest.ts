/**
 * Thin route tests for POST /admin/containers/restart (3.4 — mutating-endpoint coverage).
 *
...
function makePostEvent(token = 'admin-token', body: unknown = { service: 'assistant' }): Parameters<typeof POST>[0] {
  return {
    request: new Request('http://localhost/admin/containers/restart', {
      method: 'POST',
...
describe('POST /admin/containers/restart', () => {
