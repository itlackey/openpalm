...
describe('FOCUS-TRAP-DEDUP — packages/ui imports the shared ui-kit focus-trap module, not a local copy', () => {
  ...
  test('routes/chat/+page.svelte imports createFocusTrap/handleTrapKeydown from @openpalm/ui-kit/actions/focus-trap.js', () => {
    const src = readFileSync(CHAT_PAGE, 'utf-8');
