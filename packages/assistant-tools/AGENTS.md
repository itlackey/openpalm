...
Docker builds run outside the Bun workspace and must resolve service dependencies explicitly. **This pattern is mandatory** — see `docs/technical/authoritative/docker-dependency-resolution.md` for full details.
