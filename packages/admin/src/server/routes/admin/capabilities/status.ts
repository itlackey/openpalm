/**
 * Bun.serve handler for /admin/capabilities/status
...
import * as svelteHandlers from "../../../../routes/admin/capabilities/status/+server.js";

addRoute("/admin/capabilities/status", {
