/**
 * Bun.serve handler for /admin/capabilities/export/opencode
...
import * as svelteHandlers from "../../../../../routes/admin/capabilities/export/opencode/+server.js";

addRoute("/admin/capabilities/export/opencode", {
