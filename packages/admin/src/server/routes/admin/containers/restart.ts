/**
 * Bun.serve handler for /admin/containers/restart
...
import * as svelteHandlers from "../../../../routes/admin/containers/restart/+server.js";

addRoute("/admin/containers/restart", {
