/**
 * Bun.serve handler for /admin/automations/[name]/run
...
import * as svelteHandlers from "../../../../../routes/admin/automations/[name]/run/+server.js";

addRoute("/admin/automations/[name]/run", {
