/**
 * Bun.serve handler for /admin/automations/[name]/log
...
import * as svelteHandlers from "../../../../../routes/admin/automations/[name]/log/+server.js";

addRoute("/admin/automations/[name]/log", {
