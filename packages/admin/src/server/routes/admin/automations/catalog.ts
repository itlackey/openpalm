/**
 * Bun.serve handler for /admin/automations/catalog
...
import * as svelteHandlers from "../../../../routes/admin/automations/catalog/+server.js";

addRoute("/admin/automations/catalog", {
