/**
 * Bun.serve handler for /admin/automations/catalog/uninstall
...
import * as svelteHandlers from "../../../../../routes/admin/automations/catalog/uninstall/+server.js";

addRoute("/admin/automations/catalog/uninstall", {
