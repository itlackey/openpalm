/**
 * Bun.serve handler for /admin/opencode/providers/[id]/models
...
import * as svelteHandlers from "../../../../../../routes/admin/opencode/providers/[id]/models/+server.js";

addRoute("/admin/opencode/providers/[id]/models", {
