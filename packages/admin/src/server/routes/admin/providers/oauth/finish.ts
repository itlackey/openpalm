/**
 * Bun.serve handler for /admin/providers/oauth/finish
...
import * as svelteHandlers from "../../../../../routes/admin/providers/oauth/finish/+server.js";

addRoute("/admin/providers/oauth/finish", {
