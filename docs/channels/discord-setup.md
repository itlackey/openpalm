...
printf '%s\n' 'your-bot-token' > ~/.openpalm/knowledge/vaults/secrets/discord_bot_token
chmod 700 ~/.openpalm/knowledge/vaults/secrets
chmod 600 ~/.openpalm/knowledge/vaults/secrets/discord_bot_token
```
...
| `CHANNEL_DISCORD_SECRET_FILE` | system-managed | Path to Guardian HMAC secret file granted from `knowledge/vaults/secrets/` |
