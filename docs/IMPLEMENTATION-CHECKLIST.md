...
## OpenMemory HTTP API integration (assets/config/opencode-core/plugins/ and lib/)
...
- [x] Canonical extension source moved to assets/config/opencode-core/ and assets/config/opencode-gateway/
