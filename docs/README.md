...
| [paperclip-addon-design.md](technical/paperclip-addon-design.md) | **Design, not yet implemented.** Paperclip as a first-party addon: routing (direct vs Guardian), screening, web-UI exposure, and Tailscale target |
