...
mkdir -p "$DEV_DIR/state"/{gateway,openmemory,postgres,qdrant,assistant,channel-chat,channel-discord,channel-voice,channel-telegram,channel-openai,caddy/config,caddy/data,logs,tmp,automations}
...
for svc in gateway openmemory postgres qdrant assistant channel-chat channel-discord channel-voice channel-telegram channel-openai; do
