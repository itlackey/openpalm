...
The admin UI manages OpenCode plugins (the `plugin[]` list in `opencode.json`). Skills, agents, commands, and tools are managed manually by advanced users in the OpenCode config directory. See [Extensions Guide](../docs/extensions-guide.md) for details.
...
- [Admin Guide](../docs/admin-guide.md) — High-level setup and usage guide
- [Admin Concepts](../docs/admin-concepts.md) — Core platform concepts
- [API Reference](../docs/development/api-reference.md) — Admin API endpoints
- [Maintenance Guide](../docs/admin/maintenance.md) — Backup, restore, and upgrade procedures
